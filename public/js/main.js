...
function loadIFrame(largeImageLink, metLinkURL){

  console.log(largeImageLink);
  console.log(metLinkURL);
  ...
  img.onload = function(){
    ...
    var content = largeImageLink;
    $.featherlight(content);
  }

  img.src = largeImageLink;
  
  // onclick=window.open(metLinkURL, '');

  // img.onclick = function OpenInNewTab(metLinkURL) {
  //   console.log("i am working");
  //   var win = window.open(metLinkURL, '_blank');
  //   win.focus();
  // }
...
//loadSM2();
        ...
        for (var i = 0; i < results.sendData.words.length; i++) {
          ...
          */
            ...
            for (var j=0; j < results.sendData.words[i].images.length; j++) {
                ...
                // $("#dispImages"+i).append("<a href=\""+results.sendData.words[i].images[j].thumb+"\" data-featherlight=\"iframe\" data-featherlight-iframe-width=\"1024\" data-featherlight-iframe-min-height=\"500\" data-featherlight-iframe-maxWidth=\"100%\" data-featherlight-loading=\"<h2>Loading The Metropolitan Museum of Art</h2>\"><img src=\"" + results.sendData.words[i].images[j].thumb + "\" width=\"140\" height=\"140\"></a>");


                var res = results.sendData.words[i].images[j].thumb.replace("web-thumb", "web-large");
                var metURL = results.sendData.words[i].images[j].href
                // console.log(metURL);
                // $("#dispImages"+i).append("<a href=\""+metURL+"\" data-featherlight=\"iframe\" data-featherlight-iframe-width=\"1024\" data-featherlight-iframe-min-height=\"500\" data-featherlight-iframe-maxWidth=\"100%\" data-featherlight-loading=\"<h2>Loading The Metropolitan Museum of Art</h2>\"><img src=\"" + results.sendData.words[i].images[j].thumb + "\" width=\"140\" height=\"140\"></a>");
                
                // $("#dispImages"+i).append("<a><img src=\"" + results.sendData.words[i].images[j].thumb + "\" width=\"140\" height=\"140\"></a>");

                //this is the one wokring as of Oct
				$("#dispImages"+i).append("<img onclick=\"javascript:loadIFrame('"+res+"', '"+metURL+"' )\" src=\"" + results.sendData.words[i].images[j].thumb + "\" width=\"140\" height=\"140\">");
